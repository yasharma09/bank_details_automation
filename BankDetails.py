...
def processedFile(uploaded_file1):
    if uploaded_file1: 
        ...
        con = pymysql.connect(host ='easy-prod-db-replica-new.cpmomzsxd8rm.ap-south-1.rds.amazonaws.com',user = 'YashSharma',password = 'Vrv6XukaKb8ECUK',port=3306)
        con.connect()
        ...
        on a.bank_account_number = b.bank_account_no where a.subscription_status = 'ACTIVE'
        and a.customer_id in {}'''.format(tuple(bank_detail_df['customer_id'])),con)
